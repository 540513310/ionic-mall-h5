(function() {
  angular.module('ionicRating', []).constant('ratingConfig', {
    max: 5,
    stateOn: 5,
    stateOff: null
    ...
    return {
      ...
      template: '<ul class="rating" ng-mouseleave="reset()" ng-keydown="onKeydown($event)">' + '<li ng-repeat="r in range track by $index" ng-click="rate($index + 1)"><i class="icon ion-ios-star" ng-class="$index < value && (r.stateOn || \'active\') || (r.stateOff || \'dark\')"></i></li>' + '</ul>',
      replace: true,
